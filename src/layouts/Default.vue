<template>
  ...
  <div class="fixed min-h-screen left-0 flex flex-col items-center z-10">
    <g-link
      to="/"
      class="md:text-xl bg-primary px-2 md:py-10 py-6 font-bold text-background dis-text rounded hover:bg-opacity-25"
    >
    ...
    <g-link
      to="/blog"
      class="md:text-xl bg-primary px-2 md:py-10 py-6 font-bold text-background dis-text rounded hover:bg-opacity-25 mt-4"
    >
